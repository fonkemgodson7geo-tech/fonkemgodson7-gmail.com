...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        $pdo = getDB();
        $stmt = $pdo->prepare("SELECT * FROM users WHERE username = ? AND role = 'patient'");
...
<head>
    ...
    <title>Patient Sign In - <?php echo SITE_NAME; ?></title>
    ...
    <div class="login-container">
        <div class="login-card">
            ...
            <div class="login-footer">
                <i class="bi bi-shield-check"></i> Your health information is secure and confidential
            </div>
        </div>
    </div>
