...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($errors) {
        ...
        try {
            $pdo = getDB();
            $stmt = $pdo->prepare("INSERT INTO users (username, email, password, role, first_name, last_name) VALUES (?, ?, ?, 'trainee', ?, ?)");
...
<head>
    ...
    <title>Create Trainee Account - <?php echo SITE_NAME; ?></title>
    <link href="../assets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
</head>
<body class="bg-light">
<div class="container mt-5" style="max-width:620px;">
    <div class="card shadow-sm">
        <div class="card-header" style="background:#6f42c1;color:#fff;"><h4 class="mb-0">Create Trainee Account</h4></div>
        <div class="card-body">
            <?php if ($message): ?>
