...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        $pdo = getDB();
        $stmt = $pdo->prepare("SELECT * FROM users WHERE username = ? AND role = 'staff'");
        ...
        error_log('Staff login DB error: ' . $e->getMessage());
...
<head>
    ...
    <title>Staff Sign In - <?php echo SITE_NAME; ?></title>
...
<div class="container mt-5" style="max-width: 460px;">
    <div class="card shadow-sm">
        <div class="card-header bg-info text-white">
            <h4 class="mb-0"><i class="bi bi-briefcase"></i> Staff Portal</h4>
        </div>
        <div class="card-body">
            <?php if ($message): ?>
            ...
            <form method="post" novalidate>
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" id="username" name="username" required value="<?php echo htmlspecialchars($username ?? '', ENT_QUOTES, 'UTF-8'); ?>">
                </div>
                <div class="mb-3">
