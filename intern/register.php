...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($errors) {
        ...
        try {
            ...
            error_log('Intern register DB error: ' . $e->getMessage());
...
<head>
    ...
    <title>Create Intern Account - <?php echo SITE_NAME; ?></title>
    <link href="../assets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
</head>
<body class="bg-light">
<div class="container mt-5" style="max-width:620px;">
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white"><h4 class="mb-0">Create Intern Account</h4></div>
        <div class="card-body">
            <?php if ($message): ?>
