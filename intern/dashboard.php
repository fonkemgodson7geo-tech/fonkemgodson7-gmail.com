...
try {
    ...
    error_log('Intern shift attendance error: ' . $e->getMessage());
...
<head>
    ...
    <title>Intern Dashboard - <?php echo SITE_NAME; ?></title>
    <link href="../assets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
</head>
<body class="bg-light">
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <div class="container">
        <a class="navbar-brand" href="dashboard.php">Intern Portal</a>
...
<div class="container mt-4">
    ...
    <p class="text-muted">Intern workspace and updates portal.</p>
    ...
    <div class="card shadow-sm"><div class="card-body">Use this portal to follow assigned tasks, check communications, and track training updates.</div></div>
</div>
</body>
</html>
