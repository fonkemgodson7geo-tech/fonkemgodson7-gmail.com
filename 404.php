...
<head>
    ...
    <title>Page Not Found &mdash; <?php echo htmlspecialchars(SITE_NAME, ENT_QUOTES, 'UTF-8'); ?></title>
    <style>
        :root {
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        body {
            ...
            background:
                radial-gradient(900px 400px at 10% -10%, rgba(0,179,134,0.22), transparent 55%),
        ...
        .code { font-size: 5rem; font-weight: 800; color: var(--ok); line-height: 1; }
        ...
        .btn {
            ...
            background: linear-gradient(90deg,#00d49f,#46f0c4); color: #08131f;
...
<body>
    <div class="card">
        ...
        <p style="margin-top:1.5rem;font-size:0.85rem;">
            Customer service: <?php echo htmlspecialchars(CUSTOMER_SERVICE_NUMBER, ENT_QUOTES, 'UTF-8'); ?>
        </p>
    </div>
</body>
</html>
